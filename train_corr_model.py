...
X, y, _ = load_train_data_from_file("resources/models/corr/input/train-data.txt")
...
X, y, _ = load_train_data_from_file("resources/models/corr/input/gap-train-data.txt")
