class IPAFeatureTable:
    def __init__(self, fp="../prepare_data/etinen_symbol_data/base_ipa_symbols.csv",
                 diac_fp="../prepare_data/etinen_symbol_data/diacritic_rules.csv",
                 vow_fp="../prepare_data/etinen_symbol_data/vowel_dimensions.csv"):
    ...
    def handle_polyphthong(self, symbol):
        ...
        if len(polyphthong) == 2:
            self.encode_diphthong(symbol)
        if len(polyphthong) == 3:
            self.encode_triphthong(symbol)
